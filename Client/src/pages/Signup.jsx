  ...
  return (
    <div className="min-h-screen bg-linear-to-br  from-slate-50 via-white to-slate-50 flex items-center justify-center p-6">
      <div className="w-full max-w-5xl">
        ...
        {/* Main grid: Form | Aside (Google + Features) */}
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          {/* RIGHT: Separate Google card + Features */}
          <div className="space-y-6">
            {/* Google Sign-in Card (separate and prominent) */}
            <div className="bg-white rounded-2xl border border-slate-200 shadow-lg p-6 flex flex-col gap-4">
              ...
              <div className="flex flex-col sm:flex-row sm:items-center sm:gap-4">
                ...
                {/* Optionally keep separate "Continue with Email" CTA */}
                <button
